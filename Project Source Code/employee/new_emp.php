...
function OTP($n) {
 ...
 if (isset($_POST['insert'])){
        ...
        $sqli_qery="SELECT e.cnic,e.email,u.username from emp_details e, users u WHERE u.username='$username' OR e.cnic='$cnic' OR e.email='$email'";
        ...
        $sql= "INSERT INTO emp_details(id,name,fname,cnic,contect,dob,gender,marital,email,image,postal,city,houseaddress,edu,title, exp,hier_date) VALUES ('$acc_full','$name','$fname','$cnic','$contect','$dob','$gender','$marry','$email','$imgData','$postal','$city','$address','$edu','$title','$experience','$regisdate')";
        $current_id = mysqli_query($con, $sql) or die("<b>Error:</b> Problem on Insert data<br/>" . mysqli_error($con));
        if (isset($current_id)) {
